...
assert.ok(settings.includes('id="sd_runpod_gpu_profile"'), 'managed RunPod must expose GPU profiles');
assert.ok(settings.includes('value="available"'), 'managed RunPod must expose the availability GPU pool');
