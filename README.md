...
- Two-layer RunPod cleanup. The server plugin is authoritative and terminates idle Pods after 15 minutes by default; compatible worker images also run a delayed pod-local self-reaper as defense in depth.
